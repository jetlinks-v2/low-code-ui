      ...
      <j-col :span="16">
        <div class="config-type">
          ...
          <div class="use-btns" v-if="type === 'columns'"> 
            <j-button class="btns" @click="handleEditBtn('Detail', '查看详情', 'EyeOutlined')">查看详情</j-button>
            <j-button class="btns" @click="handleEditBtn('Update', '编辑', 'EditOutlined')">编辑</j-button>
            <j-button class="btns" @click="handleEditBtn('Delete', '删除', 'DeleteOutlined')">删除</j-button>
          </div>
          <div class="use-btns" v-else>
            <j-button class="btns" @click="handleEditBtn('Add', '新增', 'PlusOutlined')">新增</j-button>
            <j-button class="btns" @click="handleEditBtn('Import', '批量导入', 'ImportOutlined')">批量导入</j-button>
            <j-button class="btns" @click="handleEditBtn('Delete', '批量删除', 'DeleteOutlined')">批量删除</j-button>
            <j-button class="btns" @click="handleEditBtn('Export', '批量导出', 'ExportOutlined')">批量导出</j-button>
          </div>
        </div>
      </j-col>
    </j-row>
