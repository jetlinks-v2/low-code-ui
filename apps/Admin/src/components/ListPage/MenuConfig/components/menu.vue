<template>
  <div class="menu-config">
    <div class="card">
      <h3>基本信息</h3>
      <p>页面名称</p>
      <j-input v-model:value="initData.title" disabled />
      ...
      <j-form ref="basicFormRef" :model="form" class="basic-form">
        ...
        <template v-if="form.systemMenu">
          ...
          >
            ...
            <ErrorItem :errorData="errorData('name')">
          ...
          >
            <ErrorItem :errorData="errorData('icon')">
...
const initData = inject(BASE_INFO)
