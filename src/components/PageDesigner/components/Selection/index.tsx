      ...
      return <Dropdown
        ...
        v-slots={{
          overlay: () => {
            return (
              <Menu>
                <MenuItem key="copy"><Button type="link" onClick={() => { onCopy(designer.data?.id) }}>复制</Button></MenuItem>
                <MenuItem key="paste"><Button type="link" onClick={onPaste(designer.data?.id)}>粘贴</Button></MenuItem>
                <MenuItem key="shear"><Button type="link" onClick={onShear(designer.data?.id)}>剪切</Button></MenuItem>
